...
const AgricultureHoseProductSliderSing = () => {
        ...
        <div className="sing-prod-slider-con">
          ...
          <Slider {...settings}>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.agriprod2} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <p className="induapp-txt">{t("PVC suction hose")}</p>
                </div>
              </div>
            </div>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.agriprod3} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <p className="induapp-txt">{t("PVC Garden Hose")}</p>
                </div>
              </div>
            </div>
            <div className="induapp-card-main sing-prod-slider-card">
...
export default AgricultureHoseProductSliderSing;
