    ...
    <div className="ruberconv-info-main">
      <div className="ruberconv-con">
        <div className="ruberconv-max-w-head-part">
          <p className="ruberconv-head">{t("Synthetic Grease")}</p>
        ...
        <div className="ruberconv-info-flex">
          ...
          <div className="ruberconv-info-par2">
            <p className="ruberconv-part2-head">{t("Synthetic Grease")}</p>
            <p className="ruberconv-part2-txt">{t("Synthetic Grease")}</p>
          </div>
        </div>
      </div>
    </div>
...
export default SyntheticGreaseInfoSing;
