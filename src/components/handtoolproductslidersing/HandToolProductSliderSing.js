...
const HandToolProductSliderSing = () => {
        ...
        <div className="sing-prod-slider-con">
          ...
          <Slider {...settings}>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.toolsprod2} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/powertool" className="induapp-txt">
                    {t("Power Tool")}
                  </Link>
                </div>
              </div>
...
export default HandToolProductSliderSing;
