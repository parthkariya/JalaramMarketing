...
const TaperBushVBeltProductSlider = () => {
        ...
        <div className="sing-prod-slider-con">
          ...
          <Slider {...settings}>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.pulleyprod2} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/timmingpulleyvbeltpulley" className="induapp-txt">
...
export default TaperBushVBeltProductSlider;
