        ...
        <div className="sing-prod-slider-con">
          ...
          <Slider {...settings}>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.powerprod2} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/specializedbelt" className="induapp-txt">
                    {t("Specialized belt")}
                  </Link>
                </div>
              </div>
            ...
            <div className="induapp-card-main sing-prod-slider-card">
              ...
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/timmingbelt" className="induapp-txt">
                    {t("Timing belt")}
                  </Link>
                </div>
              </div>
            ...
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.powerprod3} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/polyvbelt" className="induapp-txt">
                    {t("Poly V Belt")}
                  </Link>
                </div>
              </div>
...
export default VbBeltProductSlider;
