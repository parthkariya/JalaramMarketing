...
const CanvasBeltProductSliderSing = () => {
        ...
        <div className="sing-prod-slider-con">
          ...
          <Slider {...settings}>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.flatbeltprod5} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/elevatorbelt" className="induapp-txt">
                    {t("Elevator belt")}
                  </Link>
                </div>
              </div>
            ...
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.flatbeltprod2} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/nylonbelt" className="induapp-txt">
                    {t("Nylon Flat Belt")}
                  </Link>
                </div>
              </div>
            ...
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.flatbeltprod3} alt="" className="induapp-img" />
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/elevatorbelt" className="induapp-txt">
                    {t("Elevator belt")}
...
export default CanvasBeltProductSliderSing;
