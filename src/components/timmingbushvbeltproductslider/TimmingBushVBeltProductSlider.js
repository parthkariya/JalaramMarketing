...
const TimmingBushVBeltProductSlider = () => {
          ...
          <div className="sing-prod-slider-con">
            ...
            <Slider {...settings}>
              <div className="induapp-card-main sing-prod-slider-card">
                <img src={images.homeprod3} alt="" className="induapp-img" />
                <div className="sing-prod-slider-bgclr">
                  <div className="sing-prod-slider-txtbox ">
                    <Link to="/taperbushvbelt" className="induapp-txt">
...
export default TimmingBushVBeltProductSlider;
