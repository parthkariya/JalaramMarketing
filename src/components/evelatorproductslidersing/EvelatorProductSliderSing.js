...
const EvelatorProductSliderSing = () => {
        ...
        <div className="sing-prod-slider-con">
          ...
          <Slider {...settings}>
            <div className="induapp-card-main sing-prod-slider-card">
              <img src={images.flatbeltprod4} alt="" className="induapp-img" />
            ...
            <div className="induapp-card-main sing-prod-slider-card">
              ...
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link to="/canvasbelt" className="induapp-txt">
                    {t("Canvas Flat belt")}
                  </Link>
                </div>
              </div>
            ...
            <div className="induapp-card-main sing-prod-slider-card">
              ...
              <div className="sing-prod-slider-bgclr">
                <div className="sing-prod-slider-txtbox ">
                  <Link tp="/canvasbelt" className="induapp-txt">
                    {t("Canvas Flat belt")}
                  </Link>
                </div>
              </div>
...
export default EvelatorProductSliderSing;
